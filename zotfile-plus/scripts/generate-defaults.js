...
/**
 * Script to generate defaults.js from TypeScript preferences
 * This ensures consistency between the TypeScript prefs module and the defaults.js file
 */

// Import the prefs configuration
const fs = require('fs');
const path = require('path');

// Define the preference defaults (this would normally be imported from a TypeScript file)
const prefsDefaults = {
  // Rename Patterns
